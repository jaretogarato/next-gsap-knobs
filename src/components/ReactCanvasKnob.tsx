// This is based on JoshJG's react-canvas-knob. I couldn't npm install it with my version of React, so I refactored it to use functional components. I also refactored it using typescript.
